...
namespace StardewConfigFramework
{
    public class Utility
    {
        ...
        public static void drawHoverTextWithoutShadow(SpriteBatch b, string text, SpriteFont font, int xOffset = 0, int yOffset = 0, int moneyAmountToDisplayAtBottom = -1, string boldTitleText = null, int healAmountToDisplay = -1, string[] buffIconsToDisplay = null, Item hoveredItem = null, int currencySymbol = 0, int extraItemToShowIndex = -1, int extraItemToShowAmount = -1, int overrideX = -1, int overrideY = -1, float alpha = 1f, CraftingRecipe craftingIngredients = null)
        {
            ...
            if (num7 + num2 > StardewValley.Utility.getSafeArea().Right)
            {
                num7 = StardewValley.Utility.getSafeArea().Right - num2;
                num8 += Game1.tileSize / 4;
            }
            if (num8 + num3 > StardewValley.Utility.getSafeArea().Bottom)
            {
            ...
            {
                num8 -= 4;
                StardewValley.Utility.drawTextWithShadow(b, text5, font, new Vector2((float)(num7 + Game1.tileSize / 4), (float)(num8 + Game1.tileSize / 4 + 4)), hoveredItem.getCategoryColor(), 1f, -1f, 2, 2, 1f, 3);
            ...
            if (hoveredItem != null && hoveredItem is Boots)
            {
                ...
                StardewValley.Utility.drawTextWithShadow(b, Game1.parseText(boots.description, Game1.smallFont, Game1.tileSize * 4 + Game1.tileSize / 4), font, new Vector2((float)(num7 + Game1.tileSize / 4), (float)(num8 + Game1.tileSize / 4 + 4)), Game1.textColor, 1f, -1f, -1, -1, 1f, 3);
            ...
            else if (hoveredItem != null && hoveredItem is MeleeWeapon)
            {
                ...
                StardewValley.Utility.drawTextWithShadow(b, Game1.parseText(meleeWeapon2.description, Game1.smallFont, Game1.tileSize * 4 + Game1.tileSize / 4), font, new Vector2((float)(num7 + Game1.tileSize / 4), (float)(num8 + Game1.tileSize / 4 + 4)), Game1.textColor, 1f, -1f, -1, -1, 1f, 3);
            ...
            if (buffIconsToDisplay != null)
            {
                for (int k = 0; k < buffIconsToDisplay.Length; k++)
                {
                    if (!buffIconsToDisplay[k].Equals("0"))
                    {
                        ...
                        StardewValley.Utility.drawTextWithShadow(b, text6, font, new Vector2((float)(num7 + Game1.tileSize / 4 + 34 + Game1.pixelZoom), (float)(num8 + Game1.tileSize / 4 + 8)), Game1.textColor, 1f, -1f, -1, -1, 1f, 3);
                        num8 += 34;
                    }
                }
            }
